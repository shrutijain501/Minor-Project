...
<div class="wrapper row0">
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul>
        <li><a href="/FinalTest/index.jsp"><i class="fa fa-lg fa-home"></i></a></li>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="/FinalTest/index.jsp">Street-Online</a></h1>
  ...
  <nav id="mainav" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <ul class="clear">
      <li class="active"><a href="/FinalTest/index.jsp">Home</a></li>
      <li><a href="#">Gallery</a>
      </li>
      ...
      <li><a href="/FinalTest/AboutUs.jsp">Objectives</a></li>
      <li><a href="/FinalTest/AboutUs.jsp">Contact Us</a></li>
      <li><a href="/FinalTest/AboutUs.jsp">About Us</a></li>
